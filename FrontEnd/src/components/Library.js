      ...
      <div className="text">
        <div>
          <p>
            ...
            of your plants. Plant diseases occur due to various causes, such as
            pathogens and adverse environmental conditions. They manifest in a
            violation of the functions and structure of the organism. More
            importantly, they may cause premature death of the plant or damage
            to its organs. Diagnosing different plant problems is key to the
            plant’s successful growth.
          </p>
          ...
          {expanded && (
            <>
              ...
              <ul>
                ...
                <li>
                  Environmental problems: Experienced gardeners know to consider
                  the habitat in which plants grow for proper and timely
                  protection. Each plant species has its own set of optimal
                  values of factors under which the plants will be in a normal
                  state, and their immune responses to pathogens and pests will
                  be optimal.
                </li>
                <li>
                  Plant pests and invasive plants: Plant pests include insects,
                  bugs, and various weeds that may impact the plants.
                </li>
              </ul>
              <p>
                To save the crop, you need to notice changes in the plant's
                appearance in time and take the necessary measures. It's easy to
                define all these problems at PlantIn and get professional help.
              </p>
              ...
              <ol>
                ...
                <li>
                  Look at the leaves. The holes in the leaves often point at the
                  insect pests.
                </li>
                <li>
                ...
                <li>
                  Use Plantin. With the Myplantin web version or the PlantIn app
                  for Android and iOS, you can use the identifier of the plant
                  disease that you can rely on in your further search. Moreover,
                  you can get expert help from professionals via the platform.
                </li>
              </ol>
              <p>
